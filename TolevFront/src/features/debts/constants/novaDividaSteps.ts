...
export const STEPS: StepCopy[] = [
  ...
  },
  {
    ...
    help: {
      ...
      ondeEncontrar: [
        ...
        "Nº de parcelas: aparece como “prazo” ou “nº de prestações”. É o total, incluindo as que você já pagou.",
  ...
  },
  {
    ...
    help: {
      ...
      body:
        "A diferença é sobre o que a taxa incide: sobre o valor que você pegou emprestado, ou sobre o saldo que ainda deve, com juros rendendo em cima de juros.",
      ondeEncontrar: [
